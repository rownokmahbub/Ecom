...
const Nav = () => {
  ...
  return (
    <div>
      <nav className="">
        <div className="container mx-auto px-4 sm:px-6 lg:px-16 w-full fixed top-0 z-50   drop-shadow-lg border-b border-purple-400">
          <div className="flex items-center justify-between h-16">
            <Link href="/">
              <div className="flex-shrink-0 cursor-pointer">
                <p className="font-bold text-2xl animate__animated animate__fadeInDown animate__delay-.5s ">
                  {" "}
                  RM{" "}
                  <span
            ...
            <div className="flex items-center">
              <div className="hidden md:block">
                <div className="ml-10  flex items-baseline space-x-10 animate__animated animate__fadeInDown animate__delay-.5s">
                  <Link href="uiux">
                    <p className="font-medium text-[18px]  cursor-pointer">
                      UI
                    </p>
                  </Link>
            ...
            <div className="-mr-2 flex flex-col md:hidden">
              <button
                ...
                type="button"
                className="dark:bg-gray-900   inline-flex items-center justify-center p-2 rounded-md dark:text-gray-400 hover: hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
